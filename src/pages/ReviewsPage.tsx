    ...
    return (
      <div>
        <div className="mb-8">
          ...
          <p className="text-sm text-slate-500 mt-1">Decks with cards due for review</p>
        </div>
  ...
  if (dueDecks.length === 0) {
    return (
      <EmptyState
        icon="✅"
        title="All caught up!"
        description="No decks have cards due for review. Come back later or browse all your decks."
        actionLabel="Browse all decks"
